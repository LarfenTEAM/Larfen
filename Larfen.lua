...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉"
exit 1
fi
if [ ! $token ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/LarfenTEAM/Files_Larfen/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,494913818, 494913818, 494913818, 494913818}   
...
local hash = database:sismember(bot_id.."Dev:Larfen:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLarfen(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber( 494913818) then
var = true 
elseif tonumber(user_id) == tonumber( 494913818) then
var = true 
elseif tonumber(user_id) == tonumber( 494913818) then
...
var = true  
elseif database:sismember(bot_id.."Dev:Larfen:2", user_id) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇LaRFen.")  
...
if not DevLarfen(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if text == 'تفعيل التواصل ☆' and DevLarfen(msg) then  
...
if text == 'تعطيل التواصل ☆' and DevLarfen(msg) then  
...
if text == 'ضع كليشه ستارت ☆' and DevLarfen(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'☆︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ☆' and DevLarfen(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ☆' and DevLarfen(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/LarfenTEAM/Larfen/main/Larfen.lua')
send(msg.chat_id_, msg.id_,'☆︙ تم تحديث السورس\n☆︙ لديك اخر اصدار لسورس لارفين\n☆︙ الاصدار » { v 1.6 }')
dofile('Larfen.lua')  
end
if text == 'الاصدار ☆' and DevLarfen(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ اصدار  لارفين \n☆︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ☆" and DevLarfen(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ☆' and DevLarfen(msg) then 
...
if text == 'المشتركين ☆' and DevLarfen(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ☆' and DevLarfen(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
local list = database:smembers(bot_id..'Dev:Larfen:2')
t = "\n☆︙ قائمة الثانويين \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "حصريات و تحديثات لارفين" and DevLarfen(msg) then
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات  لارفين*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇LaRFen.', url="t.me/GGIIGGG"}},
}
...
if text == ("قائمه الكتم العام ☆") and DevLarfen(msg) then
...
if text=="اذاعه خاص ☆" and msg.reply_to_message_id_ == 0 and DevLarfen(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ☆" and msg.reply_to_message_id_ == 0 and DevLarfen(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ☆" and msg.reply_to_message_id_ == 0 and DevLarfen(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ☆" and msg.reply_to_message_id_ == 0  and DevLarfen(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ☆" and msg.reply_to_message_id_ == 0  and DevLarfen(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ☆' and DevLarfen(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'☆︙  عدد الكروبات الان » { '..#group..' }'..Larfenk..''..Larfen..'\n☆︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevLarfen(msg) then
...
usertext = '\n☆︙ العضو » ['..result.title_..'](t.me/'..(username or 'GGIIGGG')..')'
status  = '\n☆︙ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevLarfen(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLarfen(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLarfen(msg) then
...
if Larfen1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GGIIGGG')..') \n☆︙ '..Larfen1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"☆︙ العضو : {["..data.first_name_.."](T.ME/GGIIGGG)}\n☆︙ ["..Larfen_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☆︙ عذرا » {["..data.first_name_.."](T.ME/GGIIGGG)}\n☆︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLarfen(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLarfen(msg) then
...
if text and text:match("^وضع قناة الاشتراك ☆$") and DevLarfen(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي معرف القناة')
return false  
end
...
if t2.id_ then 
name_MRLarfen = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRLarfen then 
names_MRLarfen = database:smembers(bot_id.."Larfen:blocname"..msg.chat_id_) or ""
if names_MRLarfen and names_MRLarfen[1] then 
for i=1,#names_MRLarfen do 
if name_MRLarfen:match("(.*)("..names_MRLarfen[i]..")(.*)") then 
...
function Larfen_mrLarfen_new(mrLarfen1,mrLarfen2)
if mrLarfen2 and mrLarfen2.first_name_ then 
if mrLarfen2.first_name_:match("(.*)"..database:get(bot_id.."Larfen:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Larfen:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrLarfen_nnn = database:get(bot_id.."Larfen:nump"..msg.chat_id_) or 5
local mrLarfen_nnn2 = database:get(bot_id.."Larfen:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrLarfen_nnn2) == tonumber(mrLarfen_nnn) or tonumber(mrLarfen_nnn2) > tonumber(mrLarfen_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Larfen:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆︙ عزيزي >>["..mrLarfen2.username_.."](https://t.me/"..(mrLarfen2.username_ or "GGIIGGG")..")\n☆︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Larfen:teh"..msg.chat_id_).."} بجانب اسمك\n☆︙ عدد المحاولات المتبقيه {"..(tonumber(mrLarfen_nnn) - tonumber(mrLarfen_nnn2)).."}")
end
end
end
end
bnnaGet(id, Larfen_mrLarfen_new)
end
end
...
☆ ↬⦑ SOURCE Larfen ⦒ 
==================
☆ ↬︙ [Source Channel](http://t.me/GGIIGGG)
==================
☆ ↬︙ [Source Update](http://t.me/GGIIGGG)      
==================
☆ ↬︙ [Source Site](http://t.me/G_NGBOT)    
===================
☆ ↬︙ [Larfen Source Developer](http://t.me/III_DD)
===================
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevLarfen(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'GGIIGGG')..') \n☆︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'GGIIGGG')..') \n☆︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLarfen(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLarfen(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevLarfen(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevLarfen(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLarfen(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,Larfen)
x = 0
tags = 0
...
if DevLarfen(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LarfenTEAM/Files_Larfen/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆∫ اهلا بك في متجر ملفات لارفين\n ☆∫ ملفات السورس ↓\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n\n"
local TextE = "\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n ☆∫ علامة تعني { ✓ } ملف مفعل\n ☆∫ علامة تعني { ✘ } ملف معطل\n ☆∫ قناة  لارفين ↓\n".." ☆∫ [اضغط هنا لدخول](t.me/GGIIGGG) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLarfen(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LarfenTEAM/Files_Larfen/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Larfen.lua')  
else
send(msg.chat_id_, msg.id_," ☆∫ عذرا الملف لايدعم  لارفين \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLarfen(msg) then
...
if text == "مسح الملفات" and DevLarfen(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ☆∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLarfen(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLarfen(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:Larfen'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:Larfen'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:Larfen'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:Larfen'..msg.chat_id_,true)  
Text = '\n☆︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:Larfen'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-Larfen")
...
database:sadd(bot_id.."Dev:Larfen:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:Larfen:2", result.id_)
...
database:sadd(bot_id.."Dev:Larfen:2", userid)
...
function Function_Larfen(extra, result, success)
database:srem(bot_id.."Dev:Larfen:2", result.sender_user_id_)
...
function Function_Larfen(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Larfen:2", result.id_)
...
database:srem(bot_id.."Dev:Larfen:2", userid)
...
database:del(bot_id.."Dev:Larfen:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GGIIGGG')..')'
status  = '\n☆︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☆︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'GGIIGGG')..')'
...
if text == 'مسح كليشه المطور' and DevLarfen(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'☆︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevLarfen(msg) then
...
if database:get(bot_id..'Bc:Bots') and not DevLarfen(msg) then 
...
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:Larfen:2',msg.sender_user_id_) then
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
database:set(bot_id.."GGIIGGG:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆ تم تفعيل الانستا')
database:set(bot_id.."GGIIGGG:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."GGIIGGG:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."GGIIGGG:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."GGIIGGG:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."GGIIGGG:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري  لارفين يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لارفين').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'GGIIGGG')..')'
local iduser = result.sender_user_id_
...
local Larfen = '☆︙ عدد الادمنيه : '..data.administrator_count_..
'\n\n☆︙ عدد المطرودين : '..data.kicked_count_..
'\n\n☆︙ عدد الاعضاء : '..data.member_count_..
'\n\n☆︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n☆︙  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, Larfen) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,Larfen,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (Larfen.total_count_ or 0)
...
local rdphoto = Larfena[math.random(#Larfena)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Larfen.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
Larfen = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,Larfen)  
...
Larfen = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,Larfen)  
...
if text == 'استعاده الاوامر' and DevLarfen(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/Larfen"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
{text = 'تنبيه المعرف', callback_data="/change-id"},{text = 'تنبيه الصور', callback_data="/change-photo"},
},
{
{text = ' 𝙎??𝙐𝙍𝘾𝞝 LaRFen', url="t.me/GGIIGGG"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." Larfen:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'𓍹ⵧⵧⵧⵧⵧⵧ⊱•LaRFen•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n☆︙ ➫ .[ LaRFen. ](t.me/GGIIGGG)➤ ')
end
...
end -- end new msg dev.mr Larfen 
end -- end callback dev.mr Larfen
